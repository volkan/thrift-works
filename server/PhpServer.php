...
require_once __DIR__.'/../lib/php/Thrift/ClassLoader/ThriftClassLoader.php';
...
$ttransport = new TBufferedTransport(new TPhpStream(TPhpStream::MODE_R | TPhpStream::MODE_W));
...
$oFactory = new TBinaryProtocolFactory();
